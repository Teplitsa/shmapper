...
We will be very grateful if you will help us to make ShMapper better.
...
If you have a questions for the plugin work in any aspect, please address our support service on [GitHub](https://github.com/Teplitsa/shmapper/issues).
...
= 1.5.1 =
* Fix vulnerable to Cross Site Scripting (XSS)
